<script lang="ts">
	...
	import type { IMember, UserRoles } from '$lib/types';
...
<div class="w-full flex justify-between items-center hover:bg-primary dark:hover:bg-primary_dark hover:text-text_secondary dark:hover:text-text_secondary_dark transition-colors px-2 ">
	<a
